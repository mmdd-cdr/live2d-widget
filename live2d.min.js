  ...
  function (t, i, e) {
        ...
        switch (this.eyeState) {
          ...
          case g.STATE_CLOSED:
            (r = (e - this.stateStartTime) / this.closedMotionMsec),
              r >= 1 &&
                ((this.eyeState = g.STATE_OPENING), (this.stateStartTime = e)),
              (i = 0);
            break;
          ...
          case g.STATE_INTERVAL:
            this.nextBlinkTime < e &&
              ((this.eyeState = g.STATE_CLOSING), (this.stateStartTime = e)),
              (i = 1);
            break;
          case g.STATE_FIRST:
          default:
    ...
    (g.STATE_FIRST = "STATE_FIRST"),
      ...
      (l.prototype.updateParam = function (t) {
        for (
          var i = UtSystem.getUserTimeMSec() - this.startTimeMSec, e = 0;
      ...
      ($.load = function (t) {
        for (
          ...
          for (
            var _ = o[s], a = _.group, h = a.length, l = new Array(), p = 0;
            p < h;
            p++
          ) {
            var f = a[p],
  ...
  function (t, i, e) {
    ...
    function u(t) {
      ...
      var i = C.getBoundingClientRect(),
        ...
        r = S(t.clientY - i.top),
        o = $(
          { x: i.left + i.width / 2, y: i.top + i.height * X },
      ...
      !(function () {
        ...
        (i._$0s = 1),
          ...
          (i.prototype.getModelImpl = function () {
            return (
              null == this._$MT && ((this._$MT = new p()), this._$MT._$zP()),
              this._$MT
            );
          }),
          ...
          (i.prototype.getPartsDataIndex = function (t) {
            return (
              t instanceof l || (t = l.getID(t)), this._$5S.getPartsDataIndex(t)
            );
          }),
          ...
          (e.prototype.init = function (t, i, e) {
            for (var o = 0; o < i.length; o++) {
              ...
              if (null != n) {
                ...
                null == s &&
                  ((s = new r(this, t, n)), this.clipContextList.push(s));
            ...
            if (e > 0) {
              ...
              (s[0] = 0),
                ...
                i.gl.bindFramebuffer(
                  i.gl.FRAMEBUFFER,
                  at.frameBuffers[this.curFrameNo].framebuffer
                ),
              ...
              for (var r = 0; r < this.clipContextList.length; r++) {
                ...
                for (
                  ...
                  o.matrixForMask[u] = $[u];
                for (
                  var p = this.tmpMatrixForDraw.getArray(), u = 0;
                  u < 16;
                  u++
                )
                  o.matrixForDraw[u] = p[u];
                for (
                  var f = o.clippingMaskDrawIndexList.length, c = 0;
                  c < f;
                  c++
                ) {
        ...
        (It._$ni = function (t, i, e, r, o, n, s, _, a) {
          ...
          (v._$br = function (t, i, e, r) {
            ...
            if (4 == o) {
              ...
              return (
                (1 - B) *
                  ((1 - P) *
                    ((1 - u) * (S + (v - S) * h) + u * (L + (M - L) * h)) +
                    P * ((1 - u) * (E + (A - E) * h) + u * (I + (w - I) * h))) +
                B *
                  ((1 - P) *
                    ((1 - u) * (x + (O - x) * h) + u * (D + (R - D) * h)) +
          ...
          (v._$Vr = function (t, i, e, r, o, n, s, _) {
            ...
            if (a <= 0) {
              ...
              for (
                var f = o[h[0]], d = o[h[1]], g = l[0], y = 1 - g, c = 0;
                c < $;
              ...
              for (
                var Et = 1 << a, At = new Float32Array(Et), It = 0;
                It < Et;
                It++
              ) {
          ...
          (I.prototype.interpolateOpacity = function (t, i, e, r) {
            null == this._$mS
              ...
              : e.setInterpolatedOpacity(v._$br(t, i, r, this._$mS));
          }),
          ...
          (O.createString = function (t, i, e) {
            for (
              var r = new ArrayBuffer(2 * e), o = new Uint16Array(r), n = 0;
              n < e;
              n++
            )
              o[n] = t.getUint8(i + n);
          ...
          (D.prototype._$Ur = function (t) {
            ...
            for (var i = t._$v2(), e = this._$Ob.length - 1; e >= 0; --e) {
              ...
              if (
                (r == x._$ds &&
                  (r = t.getParamIndex(this._$Ob[e].getParamID())),
                t._$Xb(r))
              )
                return !0;
            }
          ...
          (D.prototype._$Q2 = function (t, i) {
            for (
              var e, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0;
              _ < o;
              _++
            ) {
              var a = this._$Ob[_];
          ...
          (D.prototype._$zr = function (t, i, e) {
            ...
            for (
              var o = this._$Ob.length, n = 1, s = 1, _ = 0, a = 0;
              a < r;
              ++a
            )
              t[a] = 0;
          ...
          (R.prototype.mult_fast = function (t, i, e, r) {
            r
              ? ((e[0] = t[0] * i[0] + t[4] * i[1] + t[8] * i[2]),
                ...
                (e[15] = 1))
              : ((e[0] =
                  t[0] * i[0] + t[4] * i[1] + t[8] * i[2] + t[12] * i[3]),
                (e[4] = t[0] * i[4] + t[4] * i[5] + t[8] * i[6] + t[12] * i[7]),
                (e[8] =
                  t[0] * i[8] + t[4] * i[9] + t[8] * i[10] + t[12] * i[11]),
                (e[12] =
                  t[0] * i[12] + t[4] * i[13] + t[8] * i[14] + t[12] * i[15]),
                (e[1] = t[1] * i[0] + t[5] * i[1] + t[9] * i[2] + t[13] * i[3]),
                (e[5] = t[1] * i[4] + t[5] * i[5] + t[9] * i[6] + t[13] * i[7]),
                (e[9] =
                  t[1] * i[8] + t[5] * i[9] + t[9] * i[10] + t[13] * i[11]),
                (e[13] =
                  t[1] * i[12] + t[5] * i[13] + t[9] * i[14] + t[13] * i[15]),
                (e[2] =
                  t[2] * i[0] + t[6] * i[1] + t[10] * i[2] + t[14] * i[3]),
                (e[6] =
                  t[2] * i[4] + t[6] * i[5] + t[10] * i[6] + t[14] * i[7]),
                (e[10] =
                  t[2] * i[8] + t[6] * i[9] + t[10] * i[10] + t[14] * i[11]),
                (e[14] =
                  t[2] * i[12] + t[6] * i[13] + t[10] * i[14] + t[14] * i[15]),
                (e[3] =
                  t[3] * i[0] + t[7] * i[1] + t[11] * i[2] + t[15] * i[3]),
                (e[7] =
                  t[3] * i[4] + t[7] * i[5] + t[11] * i[6] + t[15] * i[7]),
                (e[11] =
                  t[3] * i[8] + t[7] * i[9] + t[11] * i[10] + t[15] * i[11]),
                (e[15] =
                  t[3] * i[12] + t[7] * i[13] + t[11] * i[14] + t[15] * i[15]));
          }),
          (R.prototype.translate = function (t, i, e) {
            (this.m[12] =
              this.m[0] * t + this.m[4] * i + this.m[8] * e + this.m[12]),
              (this.m[13] =
                this.m[1] * t + this.m[5] * i + this.m[9] * e + this.m[13]),
              (this.m[14] =
                this.m[2] * t + this.m[6] * i + this.m[10] * e + this.m[14]),
              (this.m[15] =
                this.m[3] * t + this.m[7] * i + this.m[11] * e + this.m[15]);
          }),
          ...
          (F.prototype.transform = function (t, i, e) {
            ...
            switch (this._$hi) {
              ...
              case F._$go | F._$fo:
                for (
                  r = this._$7, o = this._$H, s = this._$f, _ = this._$g;
                  --e >= 0;
              ...
              case F._$go | F._$gb:
                for (
                  o = this._$H, n = this._$k, s = this._$f, a = this._$w;
                  --e >= 0;
              ...
              case F._$fo | F._$gb:
                for (
                  r = this._$7, n = this._$k, _ = this._$g, a = this._$w;
                  --e >= 0;
          ...
          (C.prototype.updateParamExe = function (t, i, e, r) {
            ...
            s >= this._$yT &&
              (this._$E
                ? ((r._$z2 = i), this.loopFadeIn && (r._$bs = i))
                : (r._$9L = !0));
          }),
          ...
          (Y.prototype.update = function () {
            ...
            for (var t = this._$_2.length, i = 0; i < t; i++)
              this._$_2[i] != this._$vr[i] &&
                ((this._$Js[i] = Y._$ZS), (this._$vr[i] = this._$_2[i]));
            ...
            switch (this._$_L) {
              case STATE_CLOSING:
                (r = (e - this._$bb) / this._$Dr),
                  r >= 1 &&
                    ((r = 1), (this._$_L = wt.STATE_CLOSED), (this._$bb = e)),
                  (i = 1 - r);
                break;
              case STATE_CLOSED:
              ...
              case STATE_INTERVAL:
                this._$12 < e &&
                  ((this._$_L = wt.STATE_CLOSING), (this._$bb = e)),
                  (i = 1);
                break;
              case STATE_FIRST:
              default:
        ...
        (wt.STATE_FIRST = "STATE_FIRST"),
          ...
          (X.prototype._$K2 = function () {
            for (var t = 0; t < this._$sb.length; t++) {
              0 != this._$sb[t] &&
                (this.gl._$Sr(1, this._$sb, t), (this._$sb[t] = 0));
            }
          }),
          ...
          (z.prototype._$Nr = function (t, i) {
            ...
            if (this._$GS._$Ur(t)) {
              ...
              if ((this._$GS._$zr(n, s, o), o <= 0)) {
                ...
                for (
                  var j = 0 | Math.pow(2, o), q = new Float32Array(j), J = 0;
                  J < j;
                  J++
                ) {
                ...
                for (
                  var et = 0, rt = 0, ot = 0, nt = 0, st = 0, it = 0;
                  it < j;
                  it++
                )
                  (et += q[it] * tt[it]._$fL),
          ...
          (z.prototype._$2b = function (t, i) {
            ...
            if ((e._$hS(!0), this._$32())) {
              ...
              if (
                (e._$8r == I._$ur && (e._$8r = t.getBaseDataIndex(r)),
                e._$8r < 0)
              )
          ...
          (nt.prototype.drawElements = function (t, i, e, r, o, n, s, a) {
            try {
              o != this._$Qo &&
                ((this._$Qo = o), (this.context.globalAlpha = o));
              for (
                var h = i.length,
                  l = t.width,
                  $ = t.height,
                ...
                if (
                  ...
                  var it = a._$e0;
                  if (
                    ((it.gl_cacheImage = it.gl_cacheImage || {}),
                    !it.gl_cacheImage[P])
                  ) {
                  ...
                  at.IGNORE_CLIP ||
                    nt.clip(u, g, n, Y, O, D, R, b, F, C, M, E, A, I, w, x),
          ...
          (nt.expandClip = function (t, i, e, r, o, n, s, _, a, h) {
            ...
            return (
              null != i._$P2(N) &&
              (nt.clipWithTransform(t, N, M, E, A, I, w, x, O, D, F, C, R, b),
              !0)
            );
          }),
        ...
        (at._$yr = !1),
          ...
          ($t.prototype._$2b = function (t, i) {
            try {
              ...
              if (!e && (W.prototype._$2b.call(this, t), this._$32())) {
                ...
                if (
                  (r._$8r == W._$ur && (r._$8r = t.getBaseDataIndex(o)),
                  r._$8r < 0)
                )
                  ...
                  null == n || s._$x2()
                    ? (r._$AT = !1)
                    : (n._$nb(t, s, r._$Cr, r._$hr, this._$d0, U._$i2, U._$No),
                      (r._$AT = !0)),
          ...
          ($t.prototype.draw = function (t, i, e) {
            if (
              (this != e._$GT() && console.log("### assert!! ### "), !e._$IS[0])
            ) {
              var r = e,
                o = this._$LP;
              o < 0 && (o = 1);
          ...
          (mt.prototype._$K2 = function () {
            for (var t = 0; t < this.textures.length; t++) {
              0 != this.textures[t] &&
                (this.gl._$K2(1, this.textures, t), (this.textures[t] = null));
            }
          }),
          ...
          (mt.prototype.compileShader = function (t, i) {
            ...
            if (
              ...
              return (
                _._$Ji("_$L0 to compile shader : " + n), e.deleteShader(o), null
              );
            }
            return o;
          }),
          ...
          (St.prototype._$mP = function () {
            return (
              this._$zT(), (this._$F += 8), this._$T.getFloat64(this._$F - 8)
            );
          }),
    ...
    (o.prototype = new n.L2DBaseModel()),
              ...
              r.loadTexture(i, o, function () {
                if (r.isTexLoaded) {
                  ...
                  if (null != r.modelSetting.getHitAreasCustom()) {
                    ...
                    null != s.head_x &&
                      (h.default.hit_areas_custom_head_x = s.head_x),
                      null != s.head_y &&
                        (h.default.hit_areas_custom_head_y = s.head_y),
                      null != s.body_x &&
                        (h.default.hit_areas_custom_body_x = s.body_x),
                      null != s.body_y &&
                  ...
                  for (
                    var t = 0;
                    t < r.modelSetting.getInitPartsVisibleNum();
                    t++
                  )
      ...
      (o.prototype.update = function () {
        if (null == this.live2DModel)
          return void (
            h.default.DEBUG_LOG && console.error("Failed to update.")
          );
      ...
      (o.prototype.startMotion = function (t, i, e) {
        ...
        if (null == r || "" == r)
          return void (
            h.default.DEBUG_LOG && console.error("Failed to motion.")
          );
